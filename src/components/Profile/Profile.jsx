    ...
    <div className='profile'>
      <div className='profile-container'>
        <div className='left-sidebar'>
          ...
          <div className='orders desktop-only' onClick={() => {
            setActiveTab('current');
            // Optionally, fetch orders here if needed
          }}>
            <p>Orders</p>
          </div>
          <div className='addresses desktop-only' onClick={() => {
            setActiveTab('addresses');
            // Reset the address selector state when switching tabs, if desired
            setShowAddressSelector(false);
          }}>
        ...
        <div className='right-sidebar'>
          ...
          {activeTab === 'current' && orders && (
            <div className="orders-container desktop-only">
              <div className="order-tabs">
                <button 
                  className={activeTab === 'current' ? 'active' : ''}
                  onClick={() => setActiveTab('current')}
          ...
          {activeTab === 'addresses' && (
            <div className="address-card desktop-only">
              <h2 className="address-title">Delivery Address</h2>
              {address ? (
                <div className="address-info">
                  <div className="current-address">
